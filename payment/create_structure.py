...
# Pacote base
PACKAGE_DIR = os.path.join(BASE_DIR, "src", "main", "java", "com", "example", "payment")
...
folders = [
    ...
    os.path.join(PACKAGE_DIR, "domain", "model", "payment"),
    ...
    os.path.join(PACKAGE_DIR, "infrastructure", "messaging", "event"),
